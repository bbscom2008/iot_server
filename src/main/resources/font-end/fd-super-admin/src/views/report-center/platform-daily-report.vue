  ...
  <div class="container" :class="isShowUi ? 'isShowUi' : 'noUi'">
    ...
    <el-card class="mt-10">
      ...
      <my-table
        class="mt-10"
        ref="tableRef"
        :loadData="getPlatformReportPage"
        :tableData="tableData"
        style="width: 100%"
        border
      >
...
import {
  getPlatformReportPage,
  dailyPlatformReportSummary,
  dailyPlatformReportExport,
  dailyPlatformReportGenerate
...
export default {
  ...
  watch: {
    selectTenantId(newVal, oldVal) {
      ...
      // if (this.$route.name == 'PlatformDailyReport') {
  ...
  methods: {
    ...
    async getPlatformReportPage(page) {
      let obj = {
      ...
      let res = await getPlatformReportPage(obj, page)
    ...
    async exportReport() {
      ...
      let res = await dailyPlatformReportExport(obj)
    ...
    async onDialogBtnOk() {
      ...
      let res = await dailyPlatformReportGenerate({

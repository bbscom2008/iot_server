...
export const templateRules = {
  ...
  tutorialFilesUrl: [{ required: true, message: '请选择1-5张图片', trigger: 'change' }],
...
export const productRules = {
  ...
  isReceiveOffline: [{ required: true, message: '请选择默认值', trigger: 'change' }],
...
export const serviceRules = {
  ...
  maxConcurrentCollectOrdersCount: [
    { required: true, message: '请输入同时最大代收接单数量', trigger: 'blur' },
    ...countRules2
  ],
  maxConcurrentPaymentOrdersCount: [
    { required: true, message: '请输入同时最大代付接单数量', trigger: 'blur' },
    ...countRules2
  ],

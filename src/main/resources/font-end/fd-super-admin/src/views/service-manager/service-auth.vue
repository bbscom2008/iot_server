      ...
      >
        ...
        <!-- <el-table-column label="开启代收" align="center">
          <template slot-scope="{ row }">
            <el-tag v-if="row.isCollectEnable" type="success" > 开启</el-tag>
            <el-tag v-else type="danger">关闭</el-tag>
          </template>
        </el-table-column>
        <el-table-column label="开启代付" align="center">
          <template slot-scope="{ row }">
            <el-tag type="success" v-if="row.isPaymentEnable"> 开启</el-tag>
            <el-tag v-else type="danger">关闭</el-tag>
          </template>
        </el-table-column> -->
        <el-table-column label="码商权限" align="center">

          <el-table-column label="修改接单金额" align="center" width="90" >
            <template slot-scope="{ row }">
          ...
          <el-table-column label="代付批量接单" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isPaymentBatchAccept"> 开启</el-tag>
              <el-tag v-else type="danger">关闭</el-tag>
            </template>
          </el-table-column>
          ...
          <el-table-column label="余额划拨" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isBalanceTransfer"> 开启</el-tag>
              <el-tag v-else type="danger">关闭</el-tag>
            </template>
          </el-table-column>

          <el-table-column label="是否需要审核" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isAuditRequired"> 开启</el-tag>
              <el-tag v-else type="danger">关闭</el-tag>
            </template>
          </el-table-column>

          <el-table-column label="是否延时回款" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isDelayedPayment"> 开启</el-tag>
              <el-tag v-else type="danger">关闭</el-tag>
            </template>
          </el-table-column>

          <el-table-column label="延时回款时间(仅代付生效)" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isDelayedPayment">
                {{
        ...
        <el-table-column label="团队权限" align="center">
          <el-table-column label="查看全部下级订单" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isViewAllSubOrders"> 开启</el-tag>
              <el-tag v-else type="danger">关闭</el-tag>
            </template>
          </el-table-column>

          <el-table-column label="操作全部下级订单" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isOperateAllSubOrders"> 开启</el-tag>
              <el-tag v-else type="danger">关闭</el-tag>
            </template>
          </el-table-column>

          <el-table-column label="查看直接下级订单" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isViewDirectSubOrders"> 开启</el-tag>
              <el-tag v-else type="danger">关闭</el-tag>
            </template>
          </el-table-column>

          <el-table-column label="操作直接下级订单" align="center" width="90">
            <template slot-scope="{ row }">
              <el-tag type="success" v-if="row.isOperateDirectSubOrders"> 开启</el-tag>
              <el-tag v-else type="danger">关闭</el-tag>
            </template>
          </el-table-column>
        </el-table-column>

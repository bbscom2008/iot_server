<template>
  <div class="container">
    <div class="body" v-loading="$store.state.app.loading">
      <div class="preview">
        <div class="main">
          ...
          <div class="payinfo-box">
            <!-- 二维码卡片 -->
            <!-- <div class="qrcode card" v-if="qrConfig.isActive && qrConfig.isShow">
            ...
            <div class="submit-info card" v-if="submitConfigInfo.submitConfigs.length > 0">
              <el-form ref="submitInfoRef" class="mt-20" :model="submitConfigInfo" label-width="80px">
                <div
    ...
    >
      <el-image
        v-for="item in baseInfo.tutorialFilesUrl"
        :key="item.url"
        :src="item.url"
        style="width: 100%"
      ></el-image>
      ...
      <div slot="footer" style="text-align: center">
        <el-button type="primary" @click="tutorial_visiual = false" size="small"> 关闭 </el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog
      ...
      width="600px"
    >
      <el-form ref="submitDialogRef" :model="submitForm" label-width="80px">
        <el-form-item
          :label="baseInfo.submitTitle"
          :rules="
            baseInfo.submitCheckType == 0
              ? []
              : [
                  {
                    required: true,
      ...
      <div slot="footer" style="text-align: center">
        <el-button type="primary" @click="onSubmitBtnOk()" size="small"> 确定 </el-button>
      </div>
    </el-dialog>
  </div>
</template>

...
export default {
  ...
  created() {
    // console.log('this.$store.state[gcode-state].currEditTemplateId : ' + this.$store.state['gcode-state'].currEditTemplateId);
    
    // if (this.$store.state['gcode-state'].currEditTemplateId != -1) {
    //   let templateData =

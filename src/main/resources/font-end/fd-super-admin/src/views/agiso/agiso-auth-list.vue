  ...
  <div class="container">
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        <el-form-item label="收款码名称" prop="name">
          <el-input v-model="queryFormData.name" placeholder="请输入收款码名称" size="small" />
        </el-form-item>
        ...
        <el-form-item label="授权状态" prop="status">
          <el-select filterable  v-model="queryFormData.status" placeholder="请选择授权状态" size="small">
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="收款码名称" align="center" prop="name" />
    ...
    >
      ...
      >
        ...
        <el-form-item label="收款码名称" prop="name">
          <el-input v-model="formData.name" placeholder="请输入收款码名称" size="small" />
        </el-form-item>
        ...
        <el-form-item label="授权状态" prop="status">
          <el-select filterable  v-model="formData.status" placeholder="请选择授权状态" size="small">
            <el-option
              v-for="item in statusOptions"
              :key="item.value"
              :label="item.label"
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '收款码名称', type: 'string', key: 'name', isSearch: true, id: 1002 },
        {
          title: '支付宝码商账号',
          type: 'string',
          key: 'alipay_account',

...
// 根据商户ID删除商户
export function deleteMerchant(merchantId, params) {
  return request({
...
// 是否启用商户 是否启用商户
export function updateMerchantIsActive(merchantId, params) {

  return request({
    url: `${tempBase}/master/merchant/updateMerchantIsActive/${merchantId}`,
    method: 'get',
    params
  })
}
...
// 获取所有反查配置
export function getMerchantReverseConfig(params) {
  return request({

...
// 码商列表---创建产品与码商关联
// export function masterProviderCreateProductProviderRel(data) {
//   return request({
...
// 码商列表---分页查询产品与码商关联列表
// export function masterProviderGetProductProviderRel(data) {
//   return request({
//     url: '/master/provider/getProductProviderRel',
//     method: 'post',
//     data
//   }) 
// }
...
/**
 * 码商列表---用户账户余额变动   用户账户余额变动
 * @returns 
 */
export function financeUserAccountAvailableBalance(data) {
  return request({
    url: '/master/userAccount/availableBalance',
    method: 'post',
    data
  })
}

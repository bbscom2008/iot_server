  ...
  <div class="theme-switch" :class="{ checked }" @click.prevent="switchValue">
    ...
    <span class="theme-switch__core">
      <div class="theme-switch__action">
       ...
       <span v-if="checked" style="color: #626a91;font-size: 10px;line-height: 20px;margin-left: 2px;" >深色</span>
      <span v-else style="color: #a3aed0;font-size: 10px;line-height: 20px;margin-left: 15px;" >浅色</span>
    </span>
  </div>
</template>

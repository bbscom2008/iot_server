...
const reportCenter = [
  {
    path: '/today-report',
    component: Layout,
    redirect: '/today-report/tenant-agent-today-report',
    ...
    children: [
      {
        path: 'tenant-agent-today-report',
        component: () => import('@/views/today-report/tenant-agent-today-report'),
      ...
      {
        path: 'product-type-today-report',
        component: () => import('@/views/today-report/product-type-today-report'),

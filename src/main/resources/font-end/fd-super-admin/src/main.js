...
import StickyWhenScroll from './directive/sticky-when-scroll'
Vue.use(StickyWhenScroll)
...
Vue.use(UploadOverridePlugin, {
  ...
  autoUploadPaste: false,  // 粘贴后不自动上传

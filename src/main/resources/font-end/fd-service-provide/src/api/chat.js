 ...
 * @returns
 */
export function getHistoryConversation({providerId, isFilterClose}, page, inputOrderId) {
  return request({
    url: tempBase + `/message/providers/${providerId}/conversations?pageSize=${page.pageSize}&pageNum=${page.pageNum}&orderId=${inputOrderId}&isFilterClose=${isFilterClose}`,
    method: 'get',
  })
}

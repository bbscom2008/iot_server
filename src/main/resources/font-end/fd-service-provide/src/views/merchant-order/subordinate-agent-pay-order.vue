  ...
  <div class="container">
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="订单金额(元)" align="center" width="90px">
          <template slot-scope="{ row }">
            <div>
        ...
        <el-table-column label="收款信息" align="center" width="180" prop="paymentData">
          <template slot-scope="{ row }">
        ...
        <el-table-column label="码商" align="center">
          <template slot-scope="{ row }">
    ...
    <el-drawer title="订单详情" :visible.sync="drawer" direction="rtl" size="40%">
      ...
      <div class="request" v-loading="$store.state.app.loading">
        <p class="req-line2">
          ...
          <el-input
            ...
            readonly
            :autosize="{ minRows: 6 }"
            :value="orderDetail.paymentDesc ? orderDetail.paymentDesc : ''"
          />
        </p>
        <p class="req-line2">
          ...
          <el-input
            ...
            readonly
            :autosize="{ minRows: 6 }"
            :value="orderDetail.transferDesc ? orderDetail.transferDesc : ''"
          />
        </p>
        <p class="req-line2">
          ...
          <el-input
            ...
            readonly
            :autosize="{ minRows: 6 }"
            :value="orderDetail.auditResultRemark ? orderDetail.auditResultRemark : ''"
          />
        </p>
      </div>
      <!-- </el-tab-pane> -->
      ...
      >
        ...
        <el-form-item v-if="commonDialogType == 2" label="驳回原因" prop="rejectReson">
          <el-select
            ...
            size="small"
          >
            <!-- <el-option v-for="i in 5" :key="i" :label="`原因` + i" :value="i" /> -->
...
import { getProviderChildListByUserId } from '@/api/user.js'
...
export default {
  ...
  mounted() {
    ...
    getProviderChildListByUserId(this.$store.state.userAccount.userId).then((res) => {
      console.log(res)
      this.providerList = res.data
    })
  },
  methods: {
    ...
    showCommonDialog(row, type) {
      ...
      this.commonFormData = {
        ...
        paymentData: row.paymentData, // 收款人信息

    ...
    <el-dialog :visible.sync="dialogVisible" title="提现申请" width="600px">
      ...
      >
        ...
        <el-form-item label="交易密码" prop="tradePwd">
          <el-input type="password" show-password v-model="formData.tradePwd" placeholder="请输入交易密码" size="small" />
        </el-form-item>
...
<script>
import { getProviderWithdrawalPage, provideWithdrawalAdd } from '@/api/report-center'
    ...
    onDialogBtnOk() {
      this.$refs.formData.validate(async (valid) => {
        if (valid) {
          ...
          let res = await provideWithdrawalAdd(obj)

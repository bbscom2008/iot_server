  ...
  <div class="container">
    ...
    <el-card class="mt-10">
      ...
      <my-table
        class="mt-10"
        ref="tableRef"
        :loadData="payeeAccountDailyReportGetReportPage"
        :tableData="tableData"
        style="width: 100%"
        border
      >
...
export default {
 ...
 methods: {
    async payeeAccountDailyReportGetReportPage(page) {
      let obj = {
      ...
      let res = await payeeAccountDailyReportGetReportPage(obj, page)
    ...
    async exportReport() {
      ...
      let res = await payeeAccountDailyReportExport(obj)
      console.log(res, 'res')
      FileSaver.saveAs(res, '收款信息日报表.xlsx')
    },
    showCreateDialog() {
    ...
    async onDialogBtnOk() {
      ...
      let res = await payeeAccountDailyReportGenerate({

<template>
  <div class="container">
    ...
    <el-dialog :visible.sync="dialogVisible" title="选择导出时间" width="500px"  @close="onDialogBtnCancel">
      <el-form>
        <el-form-item>
          <el-date-picker
            v-model="exportTime"
...
<script>
import { getProviderAccountChangePage,providerAccountChangeExport } from '@/api/report-center'
import { formatDateTime } from '@/utils'
import { queryRules, cashRules } from './rules'

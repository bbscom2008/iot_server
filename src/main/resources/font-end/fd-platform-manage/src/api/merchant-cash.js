 ...
 * @returns
 */
export function exportTenantWithdrawal(data) {
  return request({
    url: '/finance/tenant/exportTenantWithdrawal',
    method: 'post',
    data,
    responseType: 'blob'
  })
 ...
 * @returns
 */
export function exportMerchantAgentWithdrawal(data) {
  return request({
    url: '/finance/merchantAgent/exportMerchantAgentWithdrawal',
    method: 'post',
    data,
    responseType: 'blob'
  })
 ...
 * @returns
 */
export function exportMerchantWithdrawal(data) {
  return request({
    url: '/finance/merchant/exportMerchantWithdrawal',
    method: 'post',
    data,
    responseType: 'blob'
  })
 ...
 * @returns
 */
export function exportProviderWithdrawal(data) {
  return request({
    url: '/finance/provide/exportProviderWithdrawal',
    method: 'post',
    data,
    responseType: 'blob'
  })

  ...
  <div class="container">
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="团队长名称" align="center" prop="userNickName" />
        ...
        <el-table-column label="成功金额" sortable align="center" width="100" prop="successfullyOrdersAmountTotal">
          <template slot-scope="{ row }">
        ...
        <el-table-column label="支付成功率" align="center" prop="paymentSuccessRate">
          <template slot-scope="{ row }"> {{ row.paymentSuccessRate }} </template>
        </el-table-column>
      </my-table>
    </el-card>
    <el-dialog
...
export default {
  ...
  methods: {
    ...
    //   // console.log(res, 'res')
    //   // FileSaver.saveAs(res, '团队管理列表.xlsx')
    // },
    goLevel(item) {

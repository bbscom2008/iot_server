<template>
  <div class="tongji-box cagetory-tongji"
    style="background-color: transparent; padding:14px 0;"
  >
...
import { merchantDailyReport } from '@/api/today-report'

  ...
  <div class="container" :class="isShowUi ? 'isShowUi' : 'noUi'">
    ...
    <div v-if="isShowUi" class="report-summary">
      <div class="tool-box">
        ...
        <div class="item-box">
          ...
          <div class="item s3">
            订单金额(元) <span class="value">{{ summaryData.orderAmount }}</span>
          </div>

          <div class="item s3">
            实付金额(元) <span class="value">{{ summaryData.payAmount }}</span>
          </div>
          ...
          <div class="item s4">
            成功订单金额(元)
            <span class="value">{{ summaryData.successfulOrderAmount }}</span>
          </div>

          <div class="item s4">
            成功实付金额(元)
            <span class="value">{{ summaryData.successfulPayAmount }}</span>
          </div>
          ...
          <div class="item s7">
            系统费用(元)
            <span class="value">{{ summaryData.systemCost }}</span>
          </div>
          <!-- <div class="item s7">
            平台代理费用(元)
            <span class="value">{{ summaryData.tenantAgentCost }}</span>
          </div> -->
          <div class="item s7">
            码商分润(元)
            <span class="value">{{ summaryData.providerCost }}</span>
          </div>
          <div class="item s7">
            商户费用(元)
            <span class="value">{{ summaryData.merchantCost }}</span>
          </div>
          <div class="item s10">
            平台利润(元)
            <span class="value">{{ summaryData.platformProfit }}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="统计日期" align="center" prop="statisticsDate" width="110">

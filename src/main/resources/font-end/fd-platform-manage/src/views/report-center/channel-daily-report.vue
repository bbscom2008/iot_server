  ...
  <div class="container" :class="isShowUi ? 'isShowUi' : 'noUi'">
    ...
    <el-card class="mt-10">
      ...
      <my-table
        class="mt-10"
        ref="tableRef"
        :loadData="channelDailyReportGetReportPage"
        :tableData="tableData"
        style="width: 100%"
        border
      >
...
import {
  channelDailyReportGetReportPage,
  channelDailyReportSummary,
  channelDailyReportExport,
  channelDailyReportGenerate
...
export default {
  ...
  methods: {
    ...
    async channelDailyReportGetReportPage(page) {
      let obj = {
      ...
      let res = await channelDailyReportGetReportPage(obj, page)
    ...
    async onDialogBtnOk() {
      ...
      let res = await channelDailyReportGenerate({

    ...
    >
      ...
      >
        ...
        <el-form-item v-if="formPatch.isUpdateMerchantRate" label="商户费率" prop="merchantRate">
          <el-input v-number-input type="number" v-model="formPatch.merchantRate" placeholder="请输入商户费率" size="small">
            <template slot="append"> % </template>
          </el-input>
        </el-form-item>
        ...
        >
          <el-input
            v-number-input type="number" v-model="formPatch.merchantPerTransactionFee"
            placeholder="请输入费用金额"
            size="small"
          >
            <template slot="append"> 元 </template>
        ...
        >
          <el-input
            v-number-input type="number" v-model="formPatch.merchantAgentProfitRate"
            placeholder="请输入比例"
            size="small"
          >
            <template slot="append"> % </template>
...
export default {
        ...
        if (valid) {
          if (this.isModAll) {
            ...
            await updateMerchantChannelRelationAll({
              ...
              ...this.formPatch,
              merchantRate: this.formPatch.isUpdateMerchantRate ? +this.formPatch.merchantRate : null, // 商户费率
              ...
              merchantPerTransactionFee: this.formPatch.isUpdateTransactionFee? Number(this.formPatch.merchantPerTransactionFee) : null, // 单笔费用
              merchantAgentProfitRate: this.formPatch.isUpdateProfitRate? Number(this.formPatch.merchantAgentProfitRate) : null, // 分润比例
            })
          } else {
  ...
  mounted() {
    ...
    console.log('----mounted--setting---', this.$store.state.tenant.currTenantId)

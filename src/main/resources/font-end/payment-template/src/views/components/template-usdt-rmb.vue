        ...
        <div class="main">
          <div class="payinfo-box-1" style="padding-bottom: 0">
            ...
            <div class="order-money-box">
              <div class="order-money">{{ orderInfo.payAmount }} USDT</div>
              
              <span class="el-icon-copy-document btn-copy-1"
                @click="
                  (e) => {
                    copyInfo(e, orderInfo.payAmount);
                  }
                ">
              ...
              <template v-for="info in textConfigInfo.texts">
                ...
                <!-- <div class="txt-info-item" :key="info.sort" > -->
                  ...
                  <span class="txt-right"
                    ><span
                      style="word-wrap: break-word; font-size: 4rem;"
                      >{{ info.textValue }}</span
                    >
                    <span @click="
                        (e) => {
            ...
            <div class="info-box">
              <div class="txt-order-no">
                ...
                <div>
                  ...
                  ></svg-icon> -->
                  <span class="value" style="margin-left: 1.6rem">{{orderInfo.merchantOrder}}</span>
                </div>
              </div>

              <div class="txt-order-no">
                <span class="txt-left">订单金额(人民币)</span>
                <div class="value">
                  <span style="font-weight: 600"
                    >{{ orderInfo.orderAmount }} 元</span
                  >
                </div>
              </div>

              <div class="txt-order-no">
                <span class="txt-left">U价汇率</span>
                <div class="value">
                  <!-- <img
                    src="@/assets/img/ttrc.png"
                    alt=""
               ...
               <div class="txt-order-no">
                <span class="txt-left">实付金额(USDT)</span>
                <div class="value">
                  <span style="font-weight: 600"
                    >{{ orderInfo.payAmount }} U</span
                  >
                </div>
              </div>

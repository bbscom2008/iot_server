<template>
  <div class="container">
    <div class="body" v-loading="$store.state.app.loading"   v-if="submit_finish"   >
      <div class="preview">
        <div class="main">
          <div class="payinfo-box-1" style="padding-bottom: 20px;">
            <div class="logo-box">
              <div class="logo">
                <img
            ...
            <div class="txt-order-no" v-if="baseInfo.isShowMerchantOrderNo && orderNum">
            ...
            <div class="text-info card" v-if="textConfigInfo.texts.length > 0">
              ...
              >
                <div class="txt-right">
                  <span style="margin-left: 2.6667rem"
                    >如需验证收款人姓名，请填写：</span
                  >
                  <span
                    style="
            ...
            <div class="qr-box" v-if="qrConfig && qrConfig.qrUrl">
              <div style="justify-content: center; display: flex; justify-content: center;">
                <div class="img-wrap" style="width: 80%" >
                  <!-- 系统解析后的二维码， -->
            ...
            <!-- 按钮信息卡片 -->
            <div class="btns card"  style="margin-top: 15px;"  v-if="buttonConfigInfo.buttons && buttonConfigInfo.buttons.length > 0">
                <div
                  class="btn-info"
    ...
    <el-dialog
      :visible.sync="info_dialog_visiual"
      title="本单只需支付"
      class="error-dialog"
      :close-on-click-modal="false"
      :show-close="false"
    ...
    >
      ...
      <div
        ...
        "
      >
        一定要复制金额粘贴到付款界面完成付款，严格按照提示金额付款，否则不回调，不补单，不查单，损失自行承担，切记切记！
      </div>

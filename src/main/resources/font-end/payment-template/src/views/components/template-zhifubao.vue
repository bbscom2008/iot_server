    ...
    <div class="body" v-loading="$store.state.app.loading">
      <div class="preview">
        ...
        <div class="main" :class="{ 'bg-loaded': bgImageLoaded }">
          <!-- ⭐ 优先级0：Logo（延迟显示，非关键）-->
          <div class="logo-box" v-show="showLogo">
            <div class="logo">
              <img
                v-if="logoIconUrl"
          ...
          <div class="payinfo-box mt-20 critical-content">
            ...
            <!-- 倒计时 -->
            <div class="cutdowntime" v-show="showCutdown">
              <div>付款倒计时：</div>
            ...
            <div v-show="showDetails">
              <div class="text-info card">
                ...
                <div
                  class="txt-info-item"
                  v-if="baseInfo.isShowMerchantOrderNo && orderNum"
                >
              ...
              >
                ...
                >
                  ...
                  <div style="text-align: center">
                    <el-button v-if="!hideSubmitBtn" type="primary" @click="onBtnSubmit"
                      >提交信息</el-button
                    >
                  </div>
                </el-form>
                  ...
                  >
                    <div class="btn-info-item">
                      ...
                      <el-button
                        ...
                        @click="(e) => btnClick(info)"
                        type="primary"
                        style="margin-bottom: 2.67rem; width: 60%;"
                        >{{ info.buttonTitle }}</el-button
                      >
                    </div>
                  </div>

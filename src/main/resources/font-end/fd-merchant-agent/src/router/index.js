...
export const asyncRoutes = [
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/merchant-agent/personal-info'),
        name: 'PersonalInfo',
        meta: { title: '个人信息' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/merchant-agent/today-report'),
        name: 'TodayReport',
        meta: { title: '今日报表' }
      }
    ]
  },
  {
    ...
    component: Layout,
    redirect: '/merchant-team-report/index',
    meta: {
      icon: 'table'
    },
    children: [

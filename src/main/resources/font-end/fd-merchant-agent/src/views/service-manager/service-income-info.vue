    ...
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        ...
        <el-form-item label="产品名称" prop="product_id">
          <el-select v-model="queryFormData.product_id" placeholder="请选择产品名称" size="small">
        ...
        <el-form-item label="是否可用" prop="is_available">
          <el-select v-model="queryFormData.is_available" placeholder="请选择是否可用" size="small">
            <el-option label="全部" value=""></el-option>
        ...
        <el-tabs v-model="activeName">
          <el-tab-pane label="收款信息配置" name="tab1">
            ...
            <el-form-item label="产品名称" prop="productId">
              <el-select v-model="formData.productId" placeholder="请选择产品" size="small">
                <el-option label="产品1" value="0" />
                <el-option label="产品2" value="1" />
                <el-option label="产品3" value="2" />
              </el-select>

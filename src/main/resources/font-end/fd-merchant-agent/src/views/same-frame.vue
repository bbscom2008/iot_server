  ...
  <div class="container">
    ...
    <el-form :inline="true" :model="formData" class="demo-form-inline">
      ...
      <el-form-item label="状态：" prop="status">
        <el-select v-model="formData.status" multiple placeholder="请选择" clearable size="small">
    ...
    <el-dialog :visible.sync="dialogVisible" title="新建模板" width="600px">
      ...
      >
        ...
        <el-form-item label="类型：" prop="type">
          <el-select v-model="form.type" placeholder="请选择" @change="selectChange" size="small">

    ...
    >
      ...
      >
        <el-form-item label="通道名称" prop="channel_name">
          ...
          <el-select v-model="formData.channel_name" placeholder="请选择" disabled>
            <el-option
              v-for="item in [
                { label: '通道1', value: '1' },
                { label: '通道2', value: '2' }
        ...
        <el-form-item label="产品名称" prop="merchant_name">
          ...
          <el-select v-model="formData.merchant_name" placeholder="请选择">
            <el-option
              v-for="item in [
                { label: '商户1', value: '1' },
                { label: '商户2', value: '2' }
  ...
  methods: {
    ...
    showAddDialog() {
      ...
      this.formData = {
        selection: '',
        merchant_name: '',
        channel_name: this.currItem.channel_name,
        is_active: '',
        operation: ''
      }
    },

  ...
  <div class="container">
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        ...
        <el-form-item label="商户名称" prop="user_nick_name">
          <el-input
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="商户名称" align="center" prop="user_nick_name" />
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '商户名称', type: 'string', key: 'user_nick_name', isSearch: true, id: 1001 },

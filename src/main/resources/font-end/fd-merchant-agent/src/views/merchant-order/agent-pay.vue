  ...
  <div class="container">
    ...
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        ...
        <!-- <el-form-item label="订单金额范围" prop="merchant_order_money">
          <el-input
            v-model="queryFormData.merchant_order_money"
            placeholder="请输入订单金额"
            size="small"
        ...
        <el-form-item label="" prop="pay_order_money">
          <el-input
            v-model="queryFormData.pay_order_money"
            placeholder="请输入实付金额"
            size="small"
        ...
        <el-form-item label="通道名称" prop="channel_name">
          <el-select v-model="queryFormData.channel_name" placeholder="请选择通道名称" size="small">
        ...
        <el-form-item label="产品名称" prop="product_name">
          <el-select v-model="queryFormData.product_name" placeholder="请选择产品名称" size="small">
            <el-option label="全部" value=""></el-option>
            <el-option
        ...
        <el-form-item label="订单状态" prop="order_state">
          <el-select v-model="queryFormData.order_state" placeholder="请选择订单状态" size="small">
            <el-option label="全部" value=""></el-option>
            <el-option
        ...
        <el-form-item label="通知状态" prop="notice_state">
          <el-select v-model="queryFormData.notice_state" placeholder="请选择通知状态" size="small">
            <el-option label="全部" value=""></el-option>
            <el-option
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="审核说明" align="center" prop="submit_info">
          <template slot-scope="{  }"> 说明文字 </template>
        </el-table-column>
    ...
    >
      ...
      >
        ...
        <el-form-item label="产品名称" prop="product_name">
          <el-select v-model="formData.product_name" placeholder="请选择产品名称" size="small">
            <el-option
              v-for="item in product_nameOptions"
              :key="item.value"
              :label="item.label"
        ...
        <el-form-item label="订单状态" prop="order_state">
          <el-select v-model="formData.order_state" placeholder="请选择订单状态" size="small">
            <el-option
              v-for="item in order_stateOptions"
              :key="item.value"
              :label="item.label"
        ...
        <el-form-item label="通知状态" prop="notice_state">
          <el-select v-model="formData.notice_state" placeholder="请选择通知状态" size="small">
            <el-option
              v-for="item in notice_stateOptions"
              :key="item.value"
              :label="item.label"
    ...
    <el-dialog :visible.sync="trans_product_visual" title="交易者信息" width="600px">
      ...
      >
        ...
        <el-table-column label="用户名" align="center">
          <template slot-scope="{ $index }"> abc-{{ $index }} </template>
        </el-table-column>
    ...
    <el-dialog :visible.sync="fenpeiDialogVisual" title="分配订单" width="600px">
      ...
      >
        ...
        <el-form-item label="选择码商" prop="choose_service">
          <el-select v-model="fenpeiFormData.choose_service">
            <el-option
              v-for="i in 10"
              :key="i"
              :label="'码商' + i"
...
export default {
  ...
  mounted() {
    ...
    let cardItems = ['订单数量', '成交订单数量', '成功率', '订单金额', '成交订单金额', '实付金额','空单数量', '空单金额', '空单占比']
    let cardTypes = ['number', 'number', 'rate', 'money', 'money', 'money', 'number','money', 'rate']

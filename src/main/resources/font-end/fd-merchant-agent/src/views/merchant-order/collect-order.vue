  ...
  <div class="container">
        ...
        <el-table-column label="金额" align="center">
          <template slot-scope="{ row }">
            <div>
              ...
              <div class="mt-5"><el-tag>实付</el-tag> {{ row.pay_order_money }}</div>
            </div>
          </template>
        </el-table-column>
    ...
    <el-dialog :visible.sync="submit_info_dialog_visible" title="查看提交信息" width="600px">
      ...
      >
        ...
        <el-form-item label="">
          <el-button type="primary" @click="submit_info_formData.isShow = true" size="small">
            查看
          </el-button>
          <div v-if="submit_info_formData.isShow">
            查看 {{ submit_info_formData.system_order_num }} 的提交信息

            <el-button
              type="text"
              @click="
                (e) => {
                  clipboard(submit_info_formData.system_order_num + '的提交信息', e)
                }
              "
              >复制</el-button
            >

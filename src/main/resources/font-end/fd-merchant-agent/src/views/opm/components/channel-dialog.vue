      ...
      >
        <el-tabs type="border-card" v-model="activeName">
          <el-tab-pane label="基本配置" name="basic">
            <el-form-item label="收款信息名称：" prop="collect_info_name">
            ...
            <el-form-item label="固定金额：" prop="fixed_amount" v-if="whichLimit == '1'">
              <el-input
                ...
                placeholder="请输入"
                size="small"
                @input="form.fixed_amount = form.fixed_amount.replace(/[^0-9]/g, '')"
              />
            </el-form-item>
            <div style="display: flex">
              <el-form-item label="范围金额：" prop="min_amount" v-if="whichLimit == '2'">
                <el-input
                  ...
                  size="small"
                  style="width: 80px"
                  @input="form.min_amount = form.min_amount.replace(/[^0-9]/g, '')"
                />
              </el-form-item>
              <el-form-item label="" prop="max_amount" v-if="whichLimit == '2'" label-width="0">
                ...
                <el-input
                  ...
                  size="small"
                  style="width: 80px"
                  @input="form.max_amount = form.max_amount.replace(/[^0-9]/g, '')"
                />
              </el-form-item>
            </div>

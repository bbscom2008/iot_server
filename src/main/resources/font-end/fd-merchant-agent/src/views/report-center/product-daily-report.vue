  ...
  <div class="container">
    ...
    <el-card class="mt-10">
      ...
      <my-table class="mt-10" ref="my-table" :loadData="mockData" :tableData="tableData" style="width: 100%" border>
        ...
        <el-table-column label="成功订单金额" align="center" prop="successfulOrderAmount"  width="130px"/>
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '产品名称', type: 'string', key: 'productName', isSearch: true, id: 1001 },
        { title: '码商名称', type: 'string', key: 'statisticDate', isSearch: true, id: 1002 },
        { title: '统计日期', type: 'date', key: 'datetimerange', isSearch: true, id: 1003 },
        ...
        { title: '成功订单数', type: 'string', key: 'successfulOrderCount', isSearch: false, id: 1006 },
        {
          title: '成功订单金额',
          type: 'number',
        ...
        { title: '实付金额', type: 'number', key: 'shifu_money', isSearch: false, id: 1008 },
      ...
      new Array(10).fill(0).forEach((_, index) => {
        ...
        columnList.forEach((column) => {
          ...
          if (column.title == '产品名称') {
            ele[column.key] = '产品' + this.tableData.length
          }

  ...
  <div class="container">
    ...
    <el-card class="mt-10">
      ...
      <my-table class="mt-10" ref="my-table" :loadData="mockData" :tableData="tableData" style="width: 100%" border >
        ...
        <el-table-column label="平台名称" align="center" prop="platformName"  width="90"/>
        <el-table-column label="订单数量" align="center" prop="orderCount"  width="105"/>
        <el-table-column label="订单金额" align="center" prop="orderAmount"  width="105"/>
        ...
        <el-table-column label="成功率" align="center" prop="successRate"  width="95"/>
        <el-table-column label="系统费用" align="center" prop="systemFee"  />
        <el-table-column label="商户费用" align="center" prop="merchantFee"  />
        <el-table-column label="码商费用" align="center" prop="serviceProviderFee"  />
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '平台名称', type: 'string', key: 'platformName', isSearch: true, id: 1002 },
        { title: '统计日期', type: 'date', key: 'statisticDate', isSearch: true, id: 1003 },
        ...
        { title: '系统费用', type: 'number', key: 'systemFee', isSearch: false, id: 1010 },
        { title: '商户费用', type: 'number', key: 'merchantFee', isSearch: false, id: 1011 },
        { title: '码商费用', type: 'number', key: 'serviceProviderFee', isSearch: false, id: 1012 },
        { title: '平台利润', type: 'number', key: 'platformProfit', isSearch: false, id: 1013 }
      ]
      this.tableData = []
      new Array(10).fill(0).forEach((_, index) => {
        ...
        columnList.forEach((column) => {
          ...
          if (column.title == '产品类型名称') {
            ele[column.key] = '产品类型' + this.tableData.length
          }

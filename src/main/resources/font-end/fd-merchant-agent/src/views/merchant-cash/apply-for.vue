  ...
  <div class="container">
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        ...
        <el-form-item label="用户名" prop="user_name">
          <el-input v-model="queryFormData.user_name" placeholder="请输入用户名" size="small" />
        </el-form-item>
    ...
    <el-card class="mt-10">
      ...
      <el-table-column label="序号" align="center" type="index" />
        ...
        <el-table-column label="提现金额" align="center" prop="withdrawal_apply_amount" sortable />
        ...
        <el-table-column label="更新时间" align="center" sortable prop="update_time">
          <template slot-scope="{ row }">
            {{ row.update_time }}
          </template>
        </el-table-column>
    ...
    <el-dialog :visible.sync="dialogVisible" :title="isEdit ? '修改' : '新增'" width="600px">
      ...
      >
        <el-form-item label="用户名" prop="user_name">
          <el-input v-model="formData.user_name" placeholder="请输入用户名" size="small" disabled />
        </el-form-item>
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '用户名', type: 'string', key: 'user_name', isSearch: true, id: 1000 },
        { title: '用户名称', type: 'string', key: 'user_nick_name', isSearch: true, id: 1001 },
        {
          title: '提现金额',
          type: 'number',

...
//全部批量结算
export function settleAll(tenantId) {
  return request({
...
export function updateMerchantActiveStatusAll(isActive) {
  return request({
    url: `${tempBase}/master/merchant/allUpdateMerchantIsActive?isActive=${isActive}`,
    method: 'post'
  })
}
...
// 获取商户开户信息
export function getMerchantBankInfo(merchantId) {
  return request({
    url: `${tempBase}/master/merchant/getMerchantOpenInfoByMerchantId/${merchantId}`,
    method: 'post'
  })
}
...
export function getMerchantInfo() {
  return request({
    url: `${tempBase}/master/merchant/getMerchantDetail`,
    method: 'get'
    })
}
// 商户端--根据商户id获取商户秘钥
export function getMerchantSecret(data) {
  return request({
    url: `${tempBase}/master/merchant/getMerchantSecret`,
    method: 'post',
    data
    })
}

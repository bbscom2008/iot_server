  ...
  <div class="container">
    ...
    <el-dialog :visible.sync="dialogVisible" title="提现申请" width="600px">
      ...
      >
        ...
        <el-form-item label="可用余额(元)" prop="availableBalance">
          <el-input
...
<script>
import { getMerchantWithdrawalPage, merchantWithdrawalAdd } from '@/api/report-center'
...
export default {
  ...
  methods: {
    async getUserAccount() {
      ...
      this.$store.state.userAccount.collectDeposit = res.data.collectDeposit
      console.log(res, 'res')
    },
    ...
    onDialogBtnOk() {
      this.$refs.formData.validate(async (valid) => {
        if (valid) {
          ...
          let res = await merchantWithdrawalAdd({

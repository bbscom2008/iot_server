  ...
  <div class="container">
    ...
    <el-card class="mt-10">
      ...
      <my-table
        class="mt-10"
        ref="tableRef"
        :loadData="merchantDailyReportGetReportPage"
        :tableData="tableData"
        style="width: 100%"
        border
      >
...
<script>
import {
  merchantDailyReportGetReportPage,
...
export default {
  ...
  methods: {
    async merchantDailyReportGetReportPage(page) {
      let obj = {
      ...
      let res = await merchantDailyReportGetReportPage(obj, page)

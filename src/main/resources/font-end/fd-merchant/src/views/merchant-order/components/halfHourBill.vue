    ...
    >
      <el-card>
        ...
        >
          ...
          <el-form-item label="收款信息名称" prop="payeeAccountName">
            <el-input
          ...
          <el-form-item label="金额（元）" prop="transAmount">
            <el-input v-model="queryFormData.transAmount" placeholder="请输入金额" size="small" />
          </el-form-item>
      ...
      <div slot="footer">
        ...
        <el-button type="primary" @click="onDialogBtnCancel()" size="small"> 确定 </el-button>
      </div>
    </el-dialog>
  </div>
</template>

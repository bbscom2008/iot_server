  ...
  <div class="container">
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        ...
        <el-form-item label="租户管理账号" prop="user_name">
          <el-input v-model="queryFormData.user_name" placeholder="请输入租户管理账号" size="small" />
        </el-form-item>

        <el-form-item label="租户名称" prop="user_nick_name">
          <el-input
        ...
        <el-form-item label="账变类型" prop="change_type">
          <el-select v-model="queryFormData.change_type" placeholder="请选择账变类型" size="small">
            <el-option label="全部" value=""></el-option>
    ...
    <el-card class="mt-10">
      ...
      <el-table-column label="交易编号" align="center" prop="deal_number" />
        <el-table-column label="租户管理账号" align="center" prop="user_name" />
        <el-table-column label="租户名称" align="center" prop="user_nick_name" />
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '租户管理账号', type: 'string', key: 'user_name', isSearch: true, id: 1000 },
        { title: '租户名称', type: 'string', key: 'user_nick_name', isSearch: true, id: 1001 },

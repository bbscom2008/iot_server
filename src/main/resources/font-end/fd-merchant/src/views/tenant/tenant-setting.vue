<template>
  <div class="container">
      ...
      <el-card>
        <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
          <el-form-item label="租户名称" prop="tenant_name">
            <el-input
              v-model="queryFormData.tenant_name"
              placeholder="请输入租户名称"
              size="small"
            />
          </el-form-item>
      ...
      <div style="max-height: 450px; overflow: auto">
        <el-card class="mt-10">
          ...
          >
            ...
            <!-- <el-table-column label="租户名称" align="center" prop="tenant_name" >
          <template slot-scope="{ row }">
            {{ currItem.tenant_name  }}
          </template>
    ...
    >
      ...
      >
        <el-form-item label="租户名称" prop="tenant_name">
          <!-- <el-input v-model="formData.tenant_name" placeholder="请输入租户名称" size="small" /> -->

          <el-select v-model="formData.tenant_name" placeholder="请选择">
            <el-option
              v-for="item in [
                { label: '租户1', value: '1' },
                { label: '租户2', value: '2' }
        ...
        <el-form-item label="产品类型名称" prop="type_name">
          ...
          <!-- 多选  -->
          <el-select v-model="formData.type_name" multiple placeholder="请选择">
            <!-- <el-option
        ...
        <el-form-item label="系统费率" prop="system_fee">
          <el-input v-model="formData.system_fee" placeholder="请输入系统费率" size="small">
            <template slot="append"> % </template>
          </el-input>
        </el-form-item>
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '租户名称', type: 'string', key: 'tenant_name', isSearch: true, id: 1001 },

  ...
  <div class="container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="收银台模板" prop="cash_page_template"  v-if="formData.trade_type=='0'"  >
          <el-select
        ...
        <el-form-item label="收款信息类型" prop="incomeType"  v-if="formData.trade_type=='1'"  >
          <el-select
        ...
        <el-form-item label="是否为静态支付信息" prop="is_payment_info_static">
          <el-switch v-model="formData.is_payment_info_static" />
        </el-form-item>

        <el-form-item label="是否为自动确认订单" prop="is_auto_confirm_order">
          <el-switch v-model="formData.is_auto_confirm_order" />
        </el-form-item>
  ...
  data() {
    return {
      ...
      formData: {
        ...
        tradeType: '',
        cash_page_template: '',
        is_payment_info_static: false,
        is_auto_confirm_order: false,
        isActive: false,
        remark: '',
        incomeType:0, // 收款信息类型
        create_time: '',

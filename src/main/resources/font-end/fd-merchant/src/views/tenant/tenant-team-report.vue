    ...
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        <el-form-item label="平台名称" prop="tenantName">
          <el-input
            v-model="queryFormData.tenantName"
            placeholder="请输入平台名称"
            size="small"
          />
        </el-form-item>
    ...
    <el-card class="mt-10">
      ...
      <my-table class="mt-10" ref="my-table" :loadData="mockData" :tableData="tableData" style="width: 100%" border>
        ...
        <el-table-column
          ...
          width="130px"
        />
        <el-table-column label="成功订单数" align="center" prop="orderNumOfSuccess"  />
        <el-table-column
          label="成功订单金额(元)"
          align="center"
          prop="orderAmountOfSuccess"
          width="160px"
        />
        <!-- <el-table-column
          label="实付金额(元)"
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '平台名称', type: 'string', key: 'tenantName', isSearch: true, id: 1001 },
        { title: '统计日期', type: 'date', key: 'date', isSearch: true, id: 1002 },
        { title: '订单数量', type: 'number', key: 'orderNum', isSearch: false, id: 1003 },
        { title: '订单金额', type: 'number', key: 'orderAmount', isSearch: false, id: 1004 },
        { title: '成功订单数', type: 'number', key: 'orderNumOfSuccess', isSearch: false, id: 1005 },
        {
          title: '成功订单金额',
          type: 'number',
          key: 'orderAmountOfSuccess',
          isSearch: false,
          id: 1006
        },
        ...
        { title: '系统费用', type: 'number', key: 'systemCost', isSearch: false, id: 1009 },
        ...
        { title: '分润比例', type: 'number', key: 'profitRate', isSearch: false, id: 1011 },
        { title: '分润', type: 'number', key: 'profit', isSearch: false, id: 1011 },

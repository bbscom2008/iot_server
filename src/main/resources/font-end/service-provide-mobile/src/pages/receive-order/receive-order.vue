    ...
    <scroll-view class="order-list" scroll-y>
      <view v-for="(item, index) in orderList" :key="index" class="order-card">
        ...
        <view class="card-footer">
          <button class="action-btn"  style="color: #fff !important;"  @click="acceptOrder(item)">接单</button>
        </view>
      </view>
    </scroll-view>

    <!-- 搜索弹窗 -->
    <u-popup ref="queryPopupRef" :show="showFilter" @maskClick="closeSearchModal()">

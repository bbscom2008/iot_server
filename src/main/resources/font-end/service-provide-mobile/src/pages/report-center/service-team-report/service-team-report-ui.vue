          ...
          <view class="summary-card">
            ...
            <view class="summary-grid" v-if="summaryInfo">
              ...
              <view class="summary-item">
                ...
                <text class="value red-txt">￥{{summaryInfo.orderAmount}} </text>
              </view>
              <view class="summary-item">
              ...
              <view class="summary-item">
                ...
                <text class="value red-txt" v-if="summaryInfo.profitAmount!=null" >{{summaryInfo.profitAmount}} 元</text>
              </view>
            </view>
          </view>
				...
				<GenReportBtnVue :type="2"  @flush-page="queryTableData()" ></GenReportBtnVue>
      ...
      <view class="query-popup">
        ...
        <scroll-view class="modal-content" scroll-y>
          <uni-forms ref="queryFormDataRef" :model="queryFormData" :rules="queryRules" label-position="top"
            ...
            <uni-forms-item label="统计日期" name="" >
  ...
  export default {
    ...
    methods: {
      ...
      async queryTableData() {
        ...
        // this.refreshTriggered = true
        let res = await providerTeamReportGetReportPage(params, this.page)
        console.log(res);
        ...
        // 汇总信息 
        let ret = await providerTeamReportSummary(params, this.page)

          ...
          <view class="summary-card">
            ...
            <view class="summary-title">
              ...
              <view class="info">
                ...
                <text class="value">{{summaryInfo.successRate}} %</text>
              </view>
            </view>
            <view class="summary-grid" v-if="summaryInfo">
              ...
              <view class="summary-item">
                ...
                <text class="value red-txt">￥{{summaryInfo.successfulOrderAmount}} </text>
              </view>
              <view class="summary-item">
              ...
              <view class="summary-item">
                ...
                <text class="value red-txt"  v-if="summaryInfo.successfulPayAmount != null"  >￥{{summaryInfo.successfulPayAmount}} </text>
              </view>
            </view>
				...
				<GenReportBtnVue :type="4"  @flush-page="queryTableData()" ></GenReportBtnVue>
...
import GenReportBtnVue from '../components/GenReportBtn.vue'
  ...
  import {
    payeeAccountDailyReportGetReportPage,
  ...
  export default {
    ...
    methods: {
      ...
      async queryTableData() {
        ...
        // this.refreshTriggered = true
        let res = await payeeAccountDailyReportGetReportPage(params, this.page)
        console.log(res);
        ...
        // 汇总信息 
        let ret = await payeeAccountDailyReportSummary(params, this.page)

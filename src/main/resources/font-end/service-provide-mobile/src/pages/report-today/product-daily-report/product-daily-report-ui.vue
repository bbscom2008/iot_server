        ...
        <view class="" v-else>
          ...
          <view v-for="(item, index) in tableData" :key="index" class="order-card">
            ...
            <view class="card-header">
              <view class="order-id">统计日期: <text class="txt" style="margin-left: 10rpx;">{{ item.statisticsDate}}</text>
              </view>
            ...
            <view class="card-body-2">
              ...
              <view class="left-box" style="100%">
                <image src="/static/imgs/product.png" style="width: 84rpx; height: 84rpx;" mode=""></image>
  ...
  export default {
    ...
    methods: {
      ...
      async queryTableData() {
        ...
        let res = await productDailyReport({
          ...params,
          ...this.page
        })
        console.log(res);
        ...
        // 汇总信息 
        let ret = await productDailyReportSummary(params)

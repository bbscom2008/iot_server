          ...
          <view class="summary-card">
            ...
            <view class="summary-grid" v-if="summaryInfo">
              ...
              <view class="summary-item">
                ...
                <text class="value red-txt" v-if="summaryInfo.realityAmount!=null" >￥{{summaryInfo.realityAmount}} </text>
              </view>
              ...
              <view class="summary-item">
                ...
                <text class="value red-txt" v-if="summaryInfo.successfulOrderAmount!= null">
                  ￥{{summaryInfo.successfulOrderAmount}} </text>
              </view>

              <view class="summary-item">
                <text class="label">分润</text>
                <text class="value red-txt" v-if="summaryInfo.profitAmount!=null">
                  ￥{{summaryInfo.profitAmount}}</text>
              </view>
            </view>
          </view>
        </view>
          ...
          <view v-for="(item, index) in tableData" :key="index" class="order-card">
            ...
            <view class="card-body-2">
              ...
              <view class="left-box" style="100%">
                <image src="/static/imgs/user1.png" style="width: 84rpx; height: 84rpx;" mode=""></image>
                <text class="txt">码商名称:</text>
                <text class="name">{{ item.providerName }}</text>
              </view>
      ...
      <view class="query-popup">
        ...
        <scroll-view class="modal-content" scroll-y>
          <uni-forms ref="queryFormDataRef" :model="queryFormData" :rules="queryRules" label-position="top"
            ...
            <uni-forms-item label="码商名称" name="providerName">
              <uni-easyinput v-model="queryFormData.providerName" placeholder="请输入码商名称"
                @blur="$refs.queryFormDataRef.validateField('providerName')" />
            </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      async queryTableData() {
        ...
        let res = await providerTeamReport({
          ...params,
          ...this.page
        })
        console.log(res);
        ...
        // 汇总信息 
        let ret = await providerTeamReportSummary(params)

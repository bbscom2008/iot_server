<template>
  <view class="svg-icon" :class="iconClass" :style="iconStyle">
    ...
    <view v-if="name === 'copy'" class="icon-content">
      <svg
        version="1.1"
        baseProfile="tiny"
        id="Layer_1"
      ...
      >
        <g>
          <g>
            <path
              d="M13.904,23.375H6.1c-2.14,0-2.25-0.033-2.296-0.048c-0.146-0.044-0.302-0.165-0.392-0.255
          ...
          <g>
            <path
              d="M19.241,19.602h-0.659c-0.221,0-0.4-0.18-0.4-0.4s0.179-0.4,0.4-0.4h0.659c0.328,0,0.64-0.004,0.716-0.011

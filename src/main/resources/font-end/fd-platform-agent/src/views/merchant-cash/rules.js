...
import { rulesCode,rulesName,userName,tradePwd,amountCheck,userNickNameRules,integerRules,userNameValidate,changeAmount} from '@/utils/validate'

const checkRichText = (rule, value, callback) => {
    if ('<p><br></p>' == value) { // 富文本内容为空
...
export const queryRules = {
  withdrawalApplyId: [integerRules],
  userNickName:[

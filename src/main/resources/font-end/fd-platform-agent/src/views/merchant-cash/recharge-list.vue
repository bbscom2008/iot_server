  ...
  <div class="container">
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        ...
        <el-form-item label="用户类型" prop="user_nick_name">
          <el-input
            v-model="queryFormData.user_nick_name"
            placeholder="请输入用户类型"
            size="small"
    ...
    <el-card class="mt-10">
      ...
      <el-table-column label="序号" align="center" type="index" />
        ...
        <el-table-column label="用户类型" align="center" prop="user_name">
          <template slot-scope="{ row, $index }"> 类型{{ $index + 1 }} </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" prop="action">
          <template slot-scope="{ row }">
            <el-button type="primary" size="small" icon="el-icon-edit" @click="showShenHeDialog(row)">
              审核
            </el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog :visible.sync="showShenHeDialogVisual" title="提现审核" width="600px">
      ...
      <div slot="footer">
        ...
        <el-button type="primary" @click="showShenHeDialogVisual = false" size="small"> 审核驳回 </el-button>
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '码商名称', type: 'string', key: 'user_nick_name', isSearch: true, id: 1001 },
        {
          title: '提现金额',
          type: 'number',

    ...
    <el-dialog :visible.sync="showShenHeDialogVisual" title="提现审核" width="600px">
      ...
      >
        <el-form-item label="交易编号" prop="userName">
          <el-input v-model="formData.userName" placeholder="请输入交易编号" size="small" disabled />
        </el-form-item>
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '账号', type: 'string', key: 'userName', isSearch: true, id: 1000 },
        { title: '代理名称', type: 'string', key: 'userNickName', isSearch: true, id: 1001 },
        {
          title: '提现金额',
          type: 'number',

    ...
    >
      ...
      >
        <el-form-item label="商户名称" prop="merchantId">
          ...
          <el-input :value="'商户1'"  disabled  placeholder="请输入租户名称" size="small" />

          <!-- <el-select filterable  v-model="formData.merchantId" placeholder="请选择" disabled>
            <el-option
        ...
        <el-form-item label="通道名称" prop="channelId">
          ...
          <el-select filterable  v-model="formData.channelId" placeholder="请选择">
            <el-option
        ...
        <el-form-item label="商户费率" prop="merchantRate">
          <el-input v-model="formData.merchantRate" placeholder="请输入商户费率" size="small" >
            <template slot="append"> % </template>
          </el-input>
        </el-form-item>

        <el-form-item label="代理分润比例" prop="merchantAgentProfitRate">
          <el-input v-model="formData.merchantAgentProfitRate" placeholder="请输入代理分润比例" size="small" >
            <template slot="append"> % </template>
          </el-input>
        </el-form-item>

        <el-form-item label="单笔费用" prop="merchantPerTransactionFee">
          <el-input v-model="formData.merchantPerTransactionFee" placeholder="请输入费用金额" size="small" >
          </el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    showAddDialog() {
      ...
      this.formData = {
        selection: '',
        merchantId: this.currItem.userNickName,
        channel_name: '',
        system_fee: '',
        is_active: '',
        operation: ''

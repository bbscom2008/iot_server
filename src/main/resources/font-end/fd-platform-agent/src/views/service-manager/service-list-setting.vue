  ...
  <div class="container">
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        ...
        <el-form-item label="产品名称" prop="channel_name">
          <el-input
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="产品名称" align="center" prop="channel_name" />
    ...
    >
      ...
      >
        <el-form-item label="码商名称" prop="merchant_name">
          <!-- <el-input v-model="formData.merchant_name" placeholder="请输入租户名称" size="small" /> -->

          <el-select filterable  v-model="formData.merchant_name" placeholder="请选择" disabled>
            <el-option
        ...
        <el-form-item label="产品名称" prop="channel_name">
          ...
          <el-select filterable  v-model="formData.channel_name" placeholder="请选择">
            <el-option
              v-for="item in [{label: '产品1', value: '1'}, {label: '产品2', value: '2'}]"
              :key="item.value"
              :label="item.label"
              :value="item.label"
            >
        ...
        <el-form-item label="码商费率" prop="system_fee">
          <el-input v-model="formData.system_fee" placeholder="请输入码商费率" size="small" >
        ...
        <el-form-item label="权重" prop="weight">
          <el-input v-model="formData.weight" placeholder="请输入费用金额" size="small" >
          </el-input>
        </el-form-item>
    ...
    <el-dialog :visible.sync="feeDialogVisible" :modal="false" title="调整费率" width="500px">
      ...
      >
        ...
        <el-form-item label="调整类型" prop="type">
          <!-- <el-checkbox-group v-model="feeFormData.type">
            <el-checkbox label="设置为该值"></el-checkbox>
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '权重', type: 'number', key: 'weight', isSearch: false, id: 1006 },
      ...
      new Array(10).fill(0).forEach((_, index) => {
        ...
        columnList.forEach((column) => {
          ...
          }else if('权重' ==column.title ){
            ele[column.key]  = this.tableData.length+1
          }

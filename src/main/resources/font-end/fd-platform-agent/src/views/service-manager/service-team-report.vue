  ...
  <div class="container">
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        <el-form-item label="码商名称" prop="service_name">
          <el-input
    ...
    <el-card class="mt-10">
      ...
      <my-table class="mt-10" ref="my-table" :loadData="mockData" :tableData="tableData" style="width: 100%" border>
        ...
        <el-table-column label="码商名称" align="center" prop="service_name" />
        ...
        <el-table-column label="成功订单金额" align="center" prop="succ_order_money"  />
        <el-table-column label="实付金额" align="center" prop="shifu_money"  />
        <el-table-column label="成功率" align="center" prop="succ_lv" />

        <!-- <el-table-column label="代付订单数量" align="center" prop="order_number" width="80"/>
        <el-table-column label="代付订单金额" align="center" prop="order_money" sortable />
        <el-table-column label="代付成功订单数" align="center" prop="succ_order_count" />
        <el-table-column label="代付成功订单金额" align="center" prop="succ_order_money" sortable width="130" />
        <el-table-column label="代付实付金额" align="center" prop="shifu_money" sortable />
        <el-table-column label="代付成功率" align="center" prop="succ_lv" /> -->


        <!-- <el-table-column label="系统费用" align="center" prop="system_cost" sortable /> -->
        <!-- <el-table-column label="商户费用" align="center" prop="merchant_cost" sortable /> -->
        <el-table-column label="分润" align="center" prop="provider_cost"  width="120"/>
        <!-- <el-table-column label="平台利润" align="center" prop="platform_lirun" /> -->
        <!-- <el-table-column label="充值金额" align="center" prop="zhongzhi_money" sortable /> -->
        <!-- <el-table-column label="提现金额" align="center" prop="tixian_money" sortable /> -->
        <!-- <el-table-column label="冻结金额" align="center" prop="dongjie_money" sortable /> -->
        <el-table-column label="日终余额(元)" align="center" prop="day_yue"  />
        <!-- <el-table-column label="分润" align="center" prop="day_yue" sortable /> -->
      </my-table>
    </el-card>
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '码商名称', type: 'string', key: 'service_name', isSearch: true, id: 1001 },
        ...
        { title: '日终余额', type: 'number', key: 'day_yue', isSearch: false, id: 1018 }
      ]
      this.tableData = []
      new Array(10).fill(0).forEach((_, index) => {
        ...
        columnList.forEach((column) => {
          ...
          if (column.title == '码商名称') {
            ele[column.key] = '码商' + this.tableData.length
          }
        })

  ...
  <div class="container">
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="当前层级" align="center">
          <template slot-scope="{ row }">
            {{ row.level }}级
            <el-button type="text" @click="showLevelTree(row)">查看子级</el-button>
          </template>
        </el-table-column>
        ...
        >
          <template slot-scope="{ row }">
            <div class="fee-box">
              <span class="val">{{ row.minAllowableCollectAmount }}</span>
    ...
    <el-dialog :visible.sync="dialogVisible" :title="isEdit ? '修改' : '新增码商'" width="600px">
      ...
      >
        ...
        <el-form-item label="选择上级码商" prop="parentId">
          <el-select
            filterable
        ...
        <!-- <el-form-item label="转账备注类型" prop="remark_type">
          <el-select filterable  v-model="formData.remark_type" placeholder="请选择转账备注类型" size="small">
            <el-option label="随机字符串" value="0"></el-option>
            <el-option label="随机6位数字默认" value="1"></el-option>
            <el-option label="随机邮箱" value="2"></el-option>
            <el-option label="随机手机号" value="3"></el-option>
            <el-option label="随机QQ号" value="4"></el-option>
          </el-select>
        </el-form-item> -->
    ...
    <el-dialog :visible.sync="showCopyDialogVisable" title="复制码商" width="500px">
      ...
      >
        ...
        <el-form-item label="码商模板" prop="tenant_template">
          <el-select
            filterable
            v-model="copyFormData.tenant_template"
            placeholder="请选择"
            size="small"
          >
            <el-option

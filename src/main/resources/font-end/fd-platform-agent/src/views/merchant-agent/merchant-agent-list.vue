  ...
  <div class="container">
    <el-card>
      <el-form :inline="true" :model="queryFormData" class="demo-form-inline">
        ...
        <el-form-item label="是否启用" prop="isActive">
          <el-switch v-model="queryFormData.isActive" size="small" />
        </el-form-item>
    ...
    <el-card class="mt-10">
      ...
      >
        ...
        <el-table-column label="商户信息" align="center" prop="merchantNum">
    ...
    <el-dialog :visible.sync="tenent_info_dialog" title="商户信息" width="700px">
      <my-table
       :tableData="tableData"
        :loadData="mockData"
        :total="50"
      ...
      >
        ...
        <el-table-column label="商户名称" align="center" width="180">
        ...
        <el-table-column label="商户代收押金" align="center">
          <template slot-scope="{ row }">
            {{ row.freeze_balance }}
          </template>
        </el-table-column>
    ...
    <el-dialog :visible.sync="showCopyDialogVisable" title="复制商户代理" width="500px">
      <el-form
        ref="copyForm"
        :model="copyFormData"
        :rules="myRules"
      ...
      >
        ...
        <el-form-item required label="代理模板" prop="copy_tenant_id">
          <el-select filterable  v-model="copyFormData.copy_tenant_id" placeholder="请选择" size="small">
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '租户信息', type: 'string', key: 'merchantNum', isSearch: true, id: 1003 },
        { title: '分润比例', type: 'string', key: 'part_profit', isSearch: true, id: 1003 },
        ...
        { title: '更新时间', type: 'date', key: 'updateTime', isSearch: false, id: 1008 },

<template>
  <div class="container">
    ...
    >
      ...
      <my-table-column align="center" label="值">
        <template slot-scope="{ row }">
          ...
          <!-- <span>http://www.qq.com</span> ,
          <span>http://www.baidu.com</span> -->
          {{ row.settingValue.join(',') }}

        </template>
      </my-table-column>
      <my-table-column align="center" label="操作">
        <template slot-scope="{ row }">
          <el-button  type="primary" size="small" @click="dialogType1(row)"
            >更新配置</el-button
          >
    ...
    <el-dialog :visible.sync="dialogVisible1" title="修改" width="600px">
      <div>
      ...
      :value="form.settingValue.join('\n')"  @change="e=>onFormChange(form,e)"   size="small" placeholder="请输入"></el-input>
      ...
      this.list = [
        {
          id:1,
          settingText:'收银台地址',
          settingValue:['http://www.qq.com','http://www.baidu.com'],

  ...
  <div class="container">
    ...
    <el-card class="mt-10">
      ...
      <div class="tips mt-10">
        ...
        <span class="mr-10">码商费用: {{ summaryData.providerFee }} </span>
      </div>
      ...
      >
        ...
        <el-table-column label="成功订单金额" align="center" prop="successfulOrderAmount" width="130" />
        <el-table-column label="实付金额" align="center" prop="actualPaymentAmount" />
        <el-table-column label="成功率" align="center" prop="successRate" />
        <el-table-column label="码商费用" align="center" prop="providerFee" width="120" />
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [
        {
          statisticDate: 22, //	统计日期	string
          providerName: 22, //	码商名称	string
          orderCount: 22, //	订单数量	integer
          orderAmount: 22, //	订单金额(元)	number
          successfulOrderCount: 22, //	成功订单数	integer
          successfulOrderAmount: 22, //	成功订单金额(元)	number
          actualPaymentAmount: 22, //	实付金额(元)	number
          successRate: 22, //	成功率(%)	number
          providerFee: 22, //	码商费用(元)	number
          endOfDayBalance: 22 //	日终余额(元)	number
        }
      ],
      dialogVisible: false,
      createdTime: '',
      ...
      summaryData: {
        orderCount: 66, //	订单数量	integer(int32)
        orderAmount: 66, //	订单金额(元)	number
        successfulOrderCount: 66, //	成功订单数	integer(int32)
        successfulOrderAmount: 66, //	成功订单金额(元)	number
        actualPaymentAmount: 66, //	实付金额(元)	number
        successRate: 66, //	成功率(%)	number
        providerFee: 66 //	码商费用(元)
      }
  ...
  methods: {
    ...
    mockData() {
      ...
      let columnList = [
        ...
        { title: '码商名称', type: 'string', key: 'providerName', isSearch: true, id: 1001 },
        ...
        { title: '码商费用', type: 'number', key: 'providerFee', isSearch: false, id: 1011 },

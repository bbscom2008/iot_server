  ...
  <div class="container">
    <el-card>
      ...
      >
        ...
        <el-form-item label="账变金额(元)" prop="changeAmount">
          <el-input
    ...
    <el-card class="mt-10">
      <my-table
        class="mt-10"
        :loadData="getTenantAgentAccountChangePage"
        :tableData="tableData"
        ref="tableRef"
        style="width: 100%"
        border
...
<script>
import { getTenantAgentAccountChangePage } from '@/api/report-center'
...
export default {
  ...
  methods: {
    async getTenantAgentAccountChangePage(page) {
      let obj = { ...this.queryFormData, tenantId: this.tenantId, userType: '1' }
      ...
      let res = await getTenantAgentAccountChangePage(rest, { ...page })

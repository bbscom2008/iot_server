    ...
    <el-dialog :visible.sync="dialogVisible" title="编辑" width="600px">
      ...
      >
        ...
        <el-form-item label="选择收银台模板:" prop="cashTemplate">
          <el-select filterable  v-model="dataForm.cashTemplate" placeholder="请选择模板" size="small">
        ...
        <el-form-item label="转账备注类型:" prop="transferType">
          <el-select filterable  v-model="dataForm.transferType" placeholder="请选择转账备注类型" size="small">

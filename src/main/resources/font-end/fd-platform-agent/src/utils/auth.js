...
const TokenKey = 'Platform-Agent-Token'
const TokenHeadKey = 'Platform-Agent-TokenHead'

const BindGoogleCodeKey = 'Platform-Agent-BindGoogleCodeKey-fsdffssrwerw'

const IsChangePasswordKey = 'Platform-Agent-isChangePassword-fsdffssrwerw'
